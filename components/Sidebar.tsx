    ...
    <div className="w-64 bg-white border-r border-gray-200 h-full flex flex-col flex-shrink-0">
      ...
      <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
        ...
        <Link
          href="/"
          onClick={onClose}
          className="flex items-center space-x-3 px-4 py-3 rounded-xl text-gray-600 hover:bg-primary-50 hover:text-primary-700 transition-colors font-medium text-sm"
        >
